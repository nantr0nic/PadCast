...
struct GamepadTextures
{
    ...
    GamepadTextures()
        ...
        , pressedA("resources/images/pressed-png/A.png")
        , pressedB("resources/images/pressed-png/B.png")
        , pressedX("resources/images/pressed-png/X.png")
        , pressedY("resources/images/pressed-png/Y.png")
        , pressedUp("resources/images/pressed-png/up.png")
        , pressedLeft("resources/images/pressed-png/left.png")
        , pressedDown("resources/images/pressed-png/down.png")
        , pressedRight("resources/images/pressed-png/right.png")
        , pressedStart("resources/images/pressed-png/start.png")
        , pressedSelect("resources/images/pressed-png/select.png")
        , pressedLBump("resources/images/pressed-png/L-bumper.png")
        , pressedRBump("resources/images/pressed-png/R-bumper.png")
    {
    }
};
